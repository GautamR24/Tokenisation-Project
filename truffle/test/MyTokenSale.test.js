...
contract("TokenSale Test", async (accounts) => {
    ...
    it("it should be possible to buy tokens", async () =>{
        ...
        let balaceBefore = await tokenInstance.balanceOf(deployerAccount);
        ...
        return await expect(tokenInstance.balanceOf(deployerAccount)).to.eventually.be.a.bignumber.equal(balaceBefore.add(new BN(1)));
    })
